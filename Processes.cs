...
namespace WinDirector.Processes
{
    public class ProcessWatcher
    {
        ...
        private void StartWatcher_EventArrived(object sender, EventArrivedEventArgs e) => OnProcessStart?.Invoke();
        private void EndWatcher_EventArrived(object sender, EventArrivedEventArgs e) => OnProcessEnd?.Invoke();
    }
    ...
    public static class Kernel
    {
        ...
        public static extern uint NtQuerySystemInformation(
            [In]        uint SystemInformationClass, // SYSTEM_INFORMATION
        ...
        public static extern int NtQueryObject(
            [In]        IntPtr Handle, 
            [In]        int ObjectInformationClass, // OBJECT_INFORMATION
    ...
    public enum OBJECT_INFORMATION : int
    {
    ...
    public enum SYSTEM_INFORMATION : uint
    {
